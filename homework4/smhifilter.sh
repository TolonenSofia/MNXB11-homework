...
#Added fillter by Soia Tolonen: Sorts poritive temeratures during 2002 from low to high based on temperature from 
FILTER_FILTERFILENAME_POSITIVE2002_LOWTOHIGH="positive2002_lowtohigh_$FILTER_FILTEREDFILENAME"
log "Filtering on only positive temperatures during 2002, then sorting from low to high, writing to $FILTER_FILTERFILENAME_POSITIVE2002_LOWTOHIGH"
awk -F',' '$3 > 0 {print $0}' $CLEANER_BAREDATAFILENAME | grep '2002' | sort -t',' -n -k3 > $FILTER_FILTERFILENAME_POSITIVE2002_LOWTOHIGH
